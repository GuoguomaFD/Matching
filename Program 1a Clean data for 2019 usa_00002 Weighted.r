...
#15.00   27.00   32.00   36.15   43.00   95.00
summary(temp$AGE[temp$SEX%in%2])
# Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
# 15.00   25.00   30.00   34.05   39.00   95.00 
...
## PERWT is the personal weights
## for marriage, use either male or female side
# Marriagesc​=j∈married females in cell c∑​PWGTPj​ or Marriagesc​=i∈married males in cell c∑​PWGTPi​
# Count the Ending available males
## MARST Marrital status 4, 5, 6
...
MaleEduAgeRace2019[1,1]<-sum(temp$PERWT[temp$RACEVar%in%1&temp$EDUVar%in%c(1,2)&temp$AgeVar%in%1])
MaleEduAgeRace2019[2,1]<-sum(temp$PERWT[temp$RACEVar%in%1&temp$EDUVar%in%c(1,2)&temp$AgeVar%in%c(2,3)])
MaleEduAgeRace2019[3,1]<-sum(temp$PERWT[temp$RACEVar%in%1&temp$EDUVar%in%c(1,2)&temp$AgeVar%in%4])

MaleEduAgeRace2019[4,1]<-sum(temp$PERWT[temp$RACEVar%in%1&temp$EDUVar%in%c(3,4)&temp$AgeVar%in%1])
MaleEduAgeRace2019[5,1]<-sum(temp$PERWT[temp$RACEVar%in%1&temp$EDUVar%in%c(3,4)&temp$AgeVar%in%c(2,3)])
MaleEduAgeRace2019[6,1]<-sum(temp$PERWT[temp$RACEVar%in%1&temp$EDUVar%in%c(3,4)&temp$AgeVar%in%4])

MaleEduAgeRace2019[7,1]<-sum(temp$PERWT[temp$RACEVar%in%2&temp$EDUVar%in%c(1,2)&temp$AgeVar%in%1])
MaleEduAgeRace2019[8,1]<-sum(temp$PERWT[temp$RACEVar%in%2&temp$EDUVar%in%c(1,2)&temp$AgeVar%in%c(2,3)])
MaleEduAgeRace2019[9,1]<-sum(temp$PERWT[temp$RACEVar%in%2&temp$EDUVar%in%c(1,2)&temp$AgeVar%in%4])

MaleEduAgeRace2019[10,1]<-sum(temp$PERWT[temp$RACEVar%in%2&temp$EDUVar%in%c(3,4)&temp$AgeVar%in%1])
MaleEduAgeRace2019[11,1]<-sum(temp$PERWT[temp$RACEVar%in%2&temp$EDUVar%in%c(3,4)&temp$AgeVar%in%c(2,3)])
MaleEduAgeRace2019[12,1]<-sum(temp$PERWT[temp$RACEVar%in%2&temp$EDUVar%in%c(3,4)&temp$AgeVar%in%4])

MaleEduAgeRace2019[13,1]<-sum(temp$PERWT[temp$RACEVar%in%c(3,4)&temp$EDUVar%in%c(1,2)&temp$AgeVar%in%1])
MaleEduAgeRace2019[14,1]<-sum(temp$PERWT[temp$RACEVar%in%c(3,4)&temp$EDUVar%in%c(1,2)&temp$AgeVar%in%c(2,3)])
MaleEduAgeRace2019[15,1]<-sum(temp$PERWT[temp$RACEVar%in%c(3,4)&temp$EDUVar%in%c(1,2)&temp$AgeVar%in%4])

MaleEduAgeRace2019[16,1]<-sum(temp$PERWT[temp$RACEVar%in%c(3,4)&temp$EDUVar%in%c(3,4)&temp$AgeVar%in%1])
MaleEduAgeRace2019[17,1]<-sum(temp$PERWT[temp$RACEVar%in%c(3,4)&temp$EDUVar%in%c(3,4)&temp$AgeVar%in%c(2,3)])
MaleEduAgeRace2019[18,1]<-sum(temp$PERWT[temp$RACEVar%in%c(3,4)&temp$EDUVar%in%c(3,4)&temp$AgeVar%in%4])
...
FemaleEduAgeRace2019[1,1]<-sum(temp$PERWT[temp$RACEVar%in%1&temp$EDUVar%in%c(1,2)&temp$AgeVar%in%1])
FemaleEduAgeRace2019[2,1]<-sum(temp$PERWT[temp$RACEVar%in%1&temp$EDUVar%in%c(1,2)&temp$AgeVar%in%c(2,3)])
FemaleEduAgeRace2019[3,1]<-sum(temp$PERWT[temp$RACEVar%in%1&temp$EDUVar%in%c(1,2)&temp$AgeVar%in%4])

FemaleEduAgeRace2019[4,1]<-sum(temp$PERWT[temp$RACEVar%in%1&temp$EDUVar%in%c(3,4)&temp$AgeVar%in%1])
FemaleEduAgeRace2019[5,1]<-sum(temp$PERWT[temp$RACEVar%in%1&temp$EDUVar%in%c(3,4)&temp$AgeVar%in%c(2,3)])
FemaleEduAgeRace2019[6,1]<-sum(temp$PERWT[temp$RACEVar%in%1&temp$EDUVar%in%c(3,4)&temp$AgeVar%in%4])

FemaleEduAgeRace2019[7,1]<-sum(temp$PERWT[temp$RACEVar%in%2&temp$EDUVar%in%c(1,2)&temp$AgeVar%in%1])
FemaleEduAgeRace2019[8,1]<-sum(temp$PERWT[temp$RACEVar%in%2&temp$EDUVar%in%c(1,2)&temp$AgeVar%in%c(2,3)])
FemaleEduAgeRace2019[9,1]<-sum(temp$PERWT[temp$RACEVar%in%2&temp$EDUVar%in%c(1,2)&temp$AgeVar%in%4])

FemaleEduAgeRace2019[10,1]<-sum(temp$PERWT[temp$RACEVar%in%2&temp$EDUVar%in%c(3,4)&temp$AgeVar%in%1])
FemaleEduAgeRace2019[11,1]<-sum(temp$PERWT[temp$RACEVar%in%2&temp$EDUVar%in%c(3,4)&temp$AgeVar%in%c(2,3)])
FemaleEduAgeRace2019[12,1]<-sum(temp$PERWT[temp$RACEVar%in%2&temp$EDUVar%in%c(3,4)&temp$AgeVar%in%4])

FemaleEduAgeRace2019[13,1]<-sum(temp$PERWT[temp$RACEVar%in%c(3,4)&temp$EDUVar%in%c(1,2)&temp$AgeVar%in%1])
FemaleEduAgeRace2019[14,1]<-sum(temp$PERWT[temp$RACEVar%in%c(3,4)&temp$EDUVar%in%c(1,2)&temp$AgeVar%in%c(2,3)])
FemaleEduAgeRace2019[15,1]<-sum(temp$PERWT[temp$RACEVar%in%c(3,4)&temp$EDUVar%in%c(1,2)&temp$AgeVar%in%4])

FemaleEduAgeRace2019[16,1]<-sum(temp$PERWT[temp$RACEVar%in%c(3,4)&temp$EDUVar%in%c(3,4)&temp$AgeVar%in%1])
FemaleEduAgeRace2019[17,1]<-sum(temp$PERWT[temp$RACEVar%in%c(3,4)&temp$EDUVar%in%c(3,4)&temp$AgeVar%in%c(2,3)])
FemaleEduAgeRace2019[18,1]<-sum(temp$PERWT[temp$RACEVar%in%c(3,4)&temp$EDUVar%in%c(3,4)&temp$AgeVar%in%4])
...
write.csv(FemaleEduAgeRaceBeginning2019,"FemaleEudAgeRaceBeginning2019BlackMaleWeighted.csv")
write.csv(FemaleEduAgeRaceEnding2019,"FemaleEudAgeRaceEnding2019BlackMaleWeighted.csv")
write.csv(MaleEduAgeRaceBeginning2019,"MaleEudAgeRaceBeginning2019BlackMaleWeighted.csv")
write.csv(MaleEduAgeRaceEnding2019,"MaleEudAgeRaceEnding2019BlackMaleWeighted.csv")
write.csv(MarriedMat,"MarriedMat2019BlackMaleWeighted.csv")
