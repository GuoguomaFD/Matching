...
###################################################
## Download 2010 1% ACS data from IPUMSR website
...
MaleEduAgeRace2010[1,1]<-length(temp$YEAR[temp$RACEVar%in%1&temp$EDUVar%in%c(1,2)&temp$AgeVar%in%1])
MaleEduAgeRace2010[2,1]<-length(temp$YEAR[temp$RACEVar%in%1&temp$EDUVar%in%c(1,2)&temp$AgeVar%in%c(2,3)])
MaleEduAgeRace2010[3,1]<-length(temp$YEAR[temp$RACEVar%in%1&temp$EDUVar%in%c(1,2)&temp$AgeVar%in%4])

MaleEduAgeRace2010[4,1]<-length(temp$YEAR[temp$RACEVar%in%1&temp$EDUVar%in%c(3,4)&temp$AgeVar%in%1])
MaleEduAgeRace2010[5,1]<-length(temp$YEAR[temp$RACEVar%in%1&temp$EDUVar%in%c(3,4)&temp$AgeVar%in%c(2,3)])
MaleEduAgeRace2010[6,1]<-length(temp$YEAR[temp$RACEVar%in%1&temp$EDUVar%in%c(3,4)&temp$AgeVar%in%4])

MaleEduAgeRace2010[7,1]<-length(temp$YEAR[temp$RACEVar%in%2&temp$EDUVar%in%c(1,2)&temp$AgeVar%in%1])
MaleEduAgeRace2010[8,1]<-length(temp$YEAR[temp$RACEVar%in%2&temp$EDUVar%in%c(1,2)&temp$AgeVar%in%c(2,3)])
MaleEduAgeRace2010[9,1]<-length(temp$YEAR[temp$RACEVar%in%2&temp$EDUVar%in%c(1,2)&temp$AgeVar%in%4])

MaleEduAgeRace2010[10,1]<-length(temp$YEAR[temp$RACEVar%in%2&temp$EDUVar%in%c(3,4)&temp$AgeVar%in%1])
MaleEduAgeRace2010[11,1]<-length(temp$YEAR[temp$RACEVar%in%2&temp$EDUVar%in%c(3,4)&temp$AgeVar%in%c(2,3)])
MaleEduAgeRace2010[12,1]<-length(temp$YEAR[temp$RACEVar%in%2&temp$EDUVar%in%c(3,4)&temp$AgeVar%in%4])

MaleEduAgeRace2010[13,1]<-length(temp$YEAR[temp$RACEVar%in%c(3,4)&temp$EDUVar%in%c(1,2)&temp$AgeVar%in%1])
MaleEduAgeRace2010[14,1]<-length(temp$YEAR[temp$RACEVar%in%c(3,4)&temp$EDUVar%in%c(1,2)&temp$AgeVar%in%c(2,3)])
MaleEduAgeRace2010[15,1]<-length(temp$YEAR[temp$RACEVar%in%c(3,4)&temp$EDUVar%in%c(1,2)&temp$AgeVar%in%4])

MaleEduAgeRace2010[16,1]<-length(temp$YEAR[temp$RACEVar%in%c(3,4)&temp$EDUVar%in%c(3,4)&temp$AgeVar%in%1])
MaleEduAgeRace2010[17,1]<-length(temp$YEAR[temp$RACEVar%in%c(3,4)&temp$EDUVar%in%c(3,4)&temp$AgeVar%in%c(2,3)])
MaleEduAgeRace2010[18,1]<-length(temp$YEAR[temp$RACEVar%in%c(3,4)&temp$EDUVar%in%c(3,4)&temp$AgeVar%in%4])
...
FemaleEduAgeRace2010[1,1]<-length(temp$YEAR[temp$RACEVar%in%1&temp$EDUVar%in%c(1,2)&temp$AgeVar%in%1])
FemaleEduAgeRace2010[2,1]<-length(temp$YEAR[temp$RACEVar%in%1&temp$EDUVar%in%c(1,2)&temp$AgeVar%in%c(2,3)])
FemaleEduAgeRace2010[3,1]<-length(temp$YEAR[temp$RACEVar%in%1&temp$EDUVar%in%c(1,2)&temp$AgeVar%in%4])

FemaleEduAgeRace2010[4,1]<-length(temp$YEAR[temp$RACEVar%in%1&temp$EDUVar%in%c(3,4)&temp$AgeVar%in%1])
FemaleEduAgeRace2010[5,1]<-length(temp$YEAR[temp$RACEVar%in%1&temp$EDUVar%in%c(3,4)&temp$AgeVar%in%c(2,3)])
FemaleEduAgeRace2010[6,1]<-length(temp$YEAR[temp$RACEVar%in%1&temp$EDUVar%in%c(3,4)&temp$AgeVar%in%4])

FemaleEduAgeRace2010[7,1]<-length(temp$YEAR[temp$RACEVar%in%2&temp$EDUVar%in%c(1,2)&temp$AgeVar%in%1])
FemaleEduAgeRace2010[8,1]<-length(temp$YEAR[temp$RACEVar%in%2&temp$EDUVar%in%c(1,2)&temp$AgeVar%in%c(2,3)])
FemaleEduAgeRace2010[9,1]<-length(temp$YEAR[temp$RACEVar%in%2&temp$EDUVar%in%c(1,2)&temp$AgeVar%in%4])

FemaleEduAgeRace2010[10,1]<-length(temp$YEAR[temp$RACEVar%in%2&temp$EDUVar%in%c(3,4)&temp$AgeVar%in%1])
FemaleEduAgeRace2010[11,1]<-length(temp$YEAR[temp$RACEVar%in%2&temp$EDUVar%in%c(3,4)&temp$AgeVar%in%c(2,3)])
FemaleEduAgeRace2010[12,1]<-length(temp$YEAR[temp$RACEVar%in%2&temp$EDUVar%in%c(3,4)&temp$AgeVar%in%4])

FemaleEduAgeRace2010[13,1]<-length(temp$YEAR[temp$RACEVar%in%c(3,4)&temp$EDUVar%in%c(1,2)&temp$AgeVar%in%1])
FemaleEduAgeRace2010[14,1]<-length(temp$YEAR[temp$RACEVar%in%c(3,4)&temp$EDUVar%in%c(1,2)&temp$AgeVar%in%c(2,3)])
FemaleEduAgeRace2010[15,1]<-length(temp$YEAR[temp$RACEVar%in%c(3,4)&temp$EDUVar%in%c(1,2)&temp$AgeVar%in%4])

FemaleEduAgeRace2010[16,1]<-length(temp$YEAR[temp$RACEVar%in%c(3,4)&temp$EDUVar%in%c(3,4)&temp$AgeVar%in%1])
FemaleEduAgeRace2010[17,1]<-length(temp$YEAR[temp$RACEVar%in%c(3,4)&temp$EDUVar%in%c(3,4)&temp$AgeVar%in%c(2,3)])
FemaleEduAgeRace2010[18,1]<-length(temp$YEAR[temp$RACEVar%in%c(3,4)&temp$EDUVar%in%c(3,4)&temp$AgeVar%in%4])
...
write.csv(FemaleEduAgeRaceBeginning2010,"FemaleEudAgeRaceBeginning2010BlackMale.csv")
write.csv(FemaleEduAgeRaceEnding2010,"FemaleEudAgeRaceEnding2010BlackMale.csv")
write.csv(MaleEduAgeRaceBeginning2010,"MaleEudAgeRaceBeginning2010BlackMale.csv")
write.csv(MaleEduAgeRaceEnding2010,"MaleEudAgeRaceEnding2010BlackMale.csv")
write.csv(MarriedMat,"MarriedMat2010BlackMale.csv")
